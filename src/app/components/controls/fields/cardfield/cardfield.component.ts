...
export class CardFieldComponent extends Field implements OnInit, AfterViewInit {

  constructor(host: ElementRef<HTMLElement>, 
              public translate : TranslateService, 
              protected templateService : TemplateService){ 
    super(host, translate)  
    this.cardInput    = templateService.assertGet(FieldTemplates.cardInput)
    this.cardBoolean  = templateService.assertGet(FieldTemplates.cardBoolean)
    this.cardEnum     = templateService.assertGet(FieldTemplates.cardEnum)
  }
  ...
  @Input()
  set assistObs(obs : NextObserver<Field>) { this.ctx.assistObs = obs}
